...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Aadd->TabIndex = 0;
			this->Aadd->Text = L"Добавить";
			this->Aadd->UseVisualStyleBackColor = true;
			this->Aadd->Click += gcnew System::EventHandler(this, &MyForm4::Aadd_Click_1);
			// 
			// comboBox1
			// 
			this->comboBox1->DropDownStyle = System::Windows::Forms::ComboBoxStyle::DropDownList;
			this->comboBox1->FormattingEnabled = true;
			this->comboBox1->Items->AddRange(gcnew cli::array< System::Object^  >(2) { L"Sneakers", L"Boots" });
