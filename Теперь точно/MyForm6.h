...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->comboBox1->Items->AddRange(gcnew cli::array< System::Object^  >(2) { L"Tshirt", L"Hoodie" });
			...
			// Aadd
			// 
			this->Aadd->Location = System::Drawing::Point(12, 232);
			...
			this->Aadd->Click += gcnew System::EventHandler(this, &MyForm6::Aadd_Click);
			// 
			// MyForm6
			// 
